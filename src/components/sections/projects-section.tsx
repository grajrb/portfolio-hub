...
const projects = [
  {
    id: 1,
    title: 'AI-Powered Voice Agent Analytics System',
    description: 'Built comprehensive voice agent analytics platform with Python FastAPI backend featuring real-time call processing, sentiment analysis, and performance metrics tracking. Implemented advanced data analytics pipeline with cloud-based persistence.',
    image: '/projects/voice-analytics.jpg',
    tags: ['Python', 'FastAPI', 'React', 'TypeScript', 'Real-time Analytics'],
    category: 'AI/ML',
    github: 'https://github.com/grajrb/voice-agent-analytics',
    demo: 'https://voice-analytics-demo.vercel.app',
    status: 'Featured',
    stats: { stars: 0, forks: 0, users: '2.1k' },
  },
  {
    id: 2,
    title: 'EventBookingSystem',
    description: 'Modern Event Management Platform with real-time updates, secure payment processing, and comprehensive event management. Developed responsive admin dashboard with advanced analytics and automated notification system.',
    ...
    status: 'Featured',
    stats: { stars: 0, forks: 0, users: '1.8k' },
  },
  {
    id: 3,
    title: 'EzCommerce',
  ...
  },
  {
    id: 6,
    title: 'Portfolio Hub',
    description: 'Modern, responsive portfolio website built with TypeScript, React, and Next.js. Features reusable UI components, project showcase, skills display, and contact information.',
