    ...
    return (
      <div className="min-h-screen flex flex-col items-center justify-center px-6 py-24 text-center">
        <div className="max-w-lg">
          <h1 className="text-3xl md:text-4xl font-bold mb-4">Tools & Resources Coming Soon</h1>
          <p className="text-muted-foreground mb-8">
            I'm preparing a curated list of the most effective development, design, and productivity tools I use daily. This section will launch shortly.
          </p>
