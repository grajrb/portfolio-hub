...
// Updated resume data with Gaurav's comprehensive information
const resumeData = {
  personal: {
    name: "Gaurav Raj",
...
const sampleAnalysis = {
  score: 87,
  strengths: [
    'Strong quantified achievements with metrics (20%, 26%, ₹870K, 25%, 80%)',
    'Comprehensive technical skills coverage',
    'Relevant industry experience with modern technologies',
    'Clear career progression from intern to full-time engineer',
    'Proven leadership and cost-saving results',
  ],
  improvements: [
    'Add more cloud-specific certifications (AWS, Azure)',
